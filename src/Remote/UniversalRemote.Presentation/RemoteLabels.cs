...
public static class RemoteLabels
{
    ...
    public static string Action(RemoteUiControl control) => control.Action.Id switch
    {
        ...
        "media.play" => Text("Lecture", "Play"), "media.pause" => Text("Pause", "Pause"), "media.stop" => Text("Stop", "Stop"),
        "media.previous" => Text("Précédent", "Previous"), "media.next" => Text("Suivant", "Next"),
        ...
        "apps.open" => Text("Applications", "Applications"), "navigation.guide" => "Guide", "navigation.epg" => "EPG",
        "navigation.settings" => Text("Réglages", "Setup"), "navigation.favorite" => Text("Favori", "Fav"), "key.shift" => "Shift",
        "navigation.exit" => Text("Quitter", "Exit"),
