...
public sealed class BuiltInOperatorCompatibilityQualifier : IOperatorCompatibilityQualifier
{
    ...
    [
        ...
        RemoteActions.Menu.Id,
        RemoteActions.ChannelUp.Id,
        RemoteActions.ChannelDown.Id,
        RemoteActions.PlayPause.Id,
        RemoteActions.Rewind.Id,
        RemoteActions.FastForward.Id,
        RemoteActions.Record.Id,
        RemoteActions.Input.Id,
        RemoteActions.Tv.Id,
        RemoteActions.Hdmi1.Id,
        RemoteActions.Hdmi2.Id,
        RemoteActions.Apps.Id,
        RemoteActions.Guide.Id,
        RemoteActions.Delete.Id,
        RemoteActions.Red.Id,
        RemoteActions.Green.Id,
        RemoteActions.Yellow.Id,
        RemoteActions.Blue.Id,
        RemoteActions.Digit0.Id,
        RemoteActions.Digit1.Id,
        RemoteActions.Digit2.Id,
        RemoteActions.Digit3.Id,
        RemoteActions.Digit4.Id,
        RemoteActions.Digit5.Id,
        RemoteActions.Digit6.Id,
        RemoteActions.Digit7.Id,
        RemoteActions.Digit8.Id,
        RemoteActions.Digit9.Id
    ];
