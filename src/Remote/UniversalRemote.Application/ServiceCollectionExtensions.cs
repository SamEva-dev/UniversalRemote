...
public static class ServiceCollectionExtensions
{
    public static IServiceCollection AddUniversalRemoteApplication(this IServiceCollection services, Action<CommandOptions>? configure = null)
    {
        ...
        services.AddTransient<IValidator<RenameDevice>, RenameDeviceValidator>();
        services.AddTransient<IRequestHandler<RenameDevice, DeviceSummary>, RenameDeviceHandler>();
